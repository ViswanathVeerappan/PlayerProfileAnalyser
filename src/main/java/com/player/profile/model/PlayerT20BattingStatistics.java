...
/**
 * The persistent class for the player_t20_batting_stats database table.
 * 
 */
@Entity
@Table(name = "player_t20_batting_stats")
public class PlayerT20BattingStatistics implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PlayerT20BattingStatisticsPrimaryKey id;
	...
	public PlayerT20BattingStatisticsPrimaryKey getId() {
		return this.id;
	}

	public void setId(PlayerT20BattingStatisticsPrimaryKey id) {
		this.id = id;
	}
